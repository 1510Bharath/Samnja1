...
SOCIAL_STRESS = {
    "english": [
        ...
        "You have 15 seconds to explain why we should value your potential over a higher-GPA student. Start now.",
    ],
    "tamil": [
        ...
        "அதிக GPA கொண்ட மாணவரை விட உங்கள் திறனை ஏன் மதிக்க வேண்டும் என்று 15 வினாடிகளில் விளக்குங்கள்.",
    ],
    "kannada": [
        ...
        "ಹೆಚ್ಚಿನ GPA ವಿದ್ಯಾರ್ಥಿಗಿಂತ ನಿಮ್ಮನ್ನು ಏಕೆ ಮೌಲ್ಯಮಾಪನ ಮಾಡಬೇಕು ಎಂಬುದನ್ನು 15 ಸೆಕೆಂಡ್‌ಗಳಲ್ಲಿ ವಿವರಿಸಿ.",
    ],
}

COGNITIVE = {
    "english": [
        "Please count backward aloud from 102 in steps of 13. Do not pause.",
        ...
        "Take the number 100. Continuously subtract 17 from it out loud until I tell you to stop.",
    ...
    "tamil": [
        "102 இலிருந்து 13 படிகளில் பின்னோக்கி எண்ணுங்கள். நிறுத்தாமல் விரைவாக செய்யுங்கள்.",
        ...
        "100 இலிருந்து தொடர்ந்து 17-ஐ கழித்துக் கொண்டே போங்கள்.",
    ...
    "kannada": [
        "102 ರಿಂದ 13 ಹೆಜ್ಜೆಗಳಲ್ಲಿ ಹಿಮ್ಮುಖವಾಗಿ ಎಣಿಸಿ. ನಿಲ್ಲಿಸದೆ ವೇಗವಾಗಿ ಮಾಡಿ.",
        ...
        "100 ರಿಂದ ನಿರಂತರವಾಗಿ 17 ಕಳೆಯುತ್ತಾ ಹೋಗಿ.",
